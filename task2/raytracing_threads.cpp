...
void threadFunc(Scene &scene, ViewPlane &viewPlane, Image &image, int xStart, int xEnd, int sizeY, int numOfSamples) {
...
int main(int argc, char **argv) {
    ...
    int block_size = viewPlaneSizeX / numberOfThreads;
